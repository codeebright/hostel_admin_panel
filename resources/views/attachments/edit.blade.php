    <div class="m-portlet__head">
        ...
        <div class="m-portlet__head-title">
            <h3 class="m-portlet__head-text">{{ trans('global.attachment_edit') }}</h3>
        </div>
        </div>
    ...
    <div class="code notranslate cssHigh collapse show" id="collapseDiv">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                <input class="form-control m-input errorDiv" type="text" name="file_name" id="file_name" value="{{$file_name}}" required>
