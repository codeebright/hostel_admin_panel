...
@section('title','واریش نمودن خوابگاه')
@section('content')
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <select class="form-control m-select2" id="m_select2_2_3" name="facility_name[]" multiple="multiple">
                                <optgroup label="امکانات لیله را انتخاب کنید">
                                    @foreach( $facility as $fa)
                                        <option value="{{$fa->id}}" {{isset($hostel_facility) && in_array($fa->id ,$hostel_facility) ? 'selected': ''}}>{{$fa->facility_name}}</option>
                                    @endforeach
                                </optgroup>
                            </select>
                        </div>
